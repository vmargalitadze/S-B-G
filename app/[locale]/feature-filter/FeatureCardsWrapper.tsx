...
interface Props {
  ...
  featureKey: MattressFeatureKey;
}

export default function FeatureCardsWrapper({ products, featureKey }: Props) {
  ...
  const filteredProducts = useMemo(() => {
    return (products ?? []).filter((product) => product.mattress?.[featureKey] === true);
  }, [products, featureKey]);
