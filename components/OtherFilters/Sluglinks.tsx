const SlugLinks = [
    ...
    { key: 'springTech', label: ' ზამბარის ტექნოლოგია', labelEn: ' Spring Technology', href: '/zone', logo: '/filters/zone.jpg' },
    ...
    { key: 'dns', label: '  საჰაერო სპონჯი', labelEn: 'Support Sponge', href: '/dns', logo: '/filters/dns.jpg' },
    { key: 'latex', label: 'ლატექსი', labelEn: 'Latex', href: '/latex', logo: '/filters/latex.jpg' },
    { key: 'washable', label: 'გასარეცხი ქეისი', labelEn: 'Washable', href: '/wash', logo: '/filters/wash.jpg' },
];
